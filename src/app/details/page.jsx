...
// Separate component for handling search params inside Suspense
...
const Details = () => {
  return (
    <Suspense fallback={<div className="w-full h-screen flex justify-center items-center"><p className='text-3xl'>Loading...</p></div>}>
      <DetailsContent />
    </Suspense>
  );
};
